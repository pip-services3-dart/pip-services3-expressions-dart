import 'package:pip_services3_expressions/src/variants/VariantType.dart';

import 'package:pip_services3_expressions/src/variants/Variant.dart';
  ...
  Variant and(Variant value1, Variant value2) {
    ...
    switch (value1.type) {
      ...
      case VariantType.Boolean:
        ...
        return result;
      default:
        throw Exception('Operation AND is not supported for type ' +
            typeToString(value1.type));
    }
  }
  ...
  Variant or(Variant value1, Variant value2) {
    ...
    switch (value1.type) {
      ...
      case VariantType.Boolean:
        ...
        return result;
      default:
        throw Exception('Operation OR is not supported for type ' +
            typeToString(value1.type));
    }
  }
  ...
  Variant not(Variant value) {
    ...
    switch (value.type) {
      ...
      case VariantType.Boolean:
        ...
        return result;
      default:
        throw Exception('Operation NOT is not supported for type ' +
